...
#ifndef M2_WIDE_GRID
#define M2_WIDE_GRID 0
#endif

#ifndef M2_OPT_LEVEL
#define M2_OPT_LEVEL 0
#endif

static_assert(M2_OPT_LEVEL >= 0 && M2_OPT_LEVEL <= 7,
              "M2_OPT_LEVEL must be in 0..7");

constexpr double unit_scale = 1.0 / 9'007'199'254'740'992.0;
#if M2_OPT_LEVEL == 0 || M2_WIDE_GRID
...
[[nodiscard]] BasicGrid<Index> make_grid(const Scenario &scenario,
    ...
    // Each cell spans at least the cutoff, unless that world dim is smaller
    const double radius =
