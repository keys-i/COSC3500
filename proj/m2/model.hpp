#ifndef MOLLY_M2_MODEL_HPP
#define MOLLY_M2_MODEL_HPP
...
struct State {
    ...
    // Transform tracks are allocated only when a timeline script uses them
    std::vector<double> timeline_rotation;
    std::vector<double> timeline_scale;
    std::vector<double> timeline_opacity;
    std::vector<double> timeline_start_rotation;
    std::vector<double> timeline_start_scale;
    std::vector<double> timeline_start_opacity;
    std::vector<double> timeline_target_rotation;
    std::vector<double> timeline_target_scale;
    std::vector<double> timeline_target_opacity;
    std::vector<std::uint64_t> timeline_transform_start_step;
    std::vector<std::uint64_t> timeline_transform_end_step;
